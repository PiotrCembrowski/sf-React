/**
 * v0 by Vercel.
 * @see https://v0.dev/t/TRvAgNBrWeV
    ...
    <div className="grid min-h-screen w-full lg:grid-cols-[280px_1fr]">
      ...
      <div className="flex flex-col">
        <header className="flex h-14 lg:h-[60px] items-center gap-4 border-b bg-gray-100/40 px-6 dark:bg-gray-800/40">
          ...
          <nav className="hidden md:flex items-center gap-4 lg:ml-auto lg:gap-2">
            <Link className="flex items-center gap-2 text-sm font-semibold sm:ml-auto" href="#">
              <UsersIcon className="h-4 w-4" />
              Users
            </Link>
            <Link className="flex items-center gap-2 text-sm font-semibold sm:ml-auto" href="#">
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button
                className="rounded-full border border-gray-200 w-8 h-8 lg:ml-auto lg:mr-4 dark:border-gray-800"
                size="icon"
                variant="ghost"
              >
                <img
